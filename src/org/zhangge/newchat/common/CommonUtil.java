...
public class CommonUtil {
	...
	public static int PORT = 20000;//设置服务器端口号
	...
	public static String WELCOME_MESSAGE = "********欢迎新登陆用户^_^: ";//成功登陆的欢迎信息
	public static String DEFAULT_HOST = "127.0.0.1";//默认服务器地址
	public static String LOGIN_TITLE = "登陆窗口";//登陆窗口标题
	...
	public static String MAIN_TITLE = "聊天窗口";//聊天主窗口标题
	...
	public static String IOEXCEPTION_MESSAGE = "未知IO错误，请重新再试试！";//IOException错误提示
